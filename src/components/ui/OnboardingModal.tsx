...
export default function OnboardingModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/65 backdrop-blur-2xl animate-in fade-in select-none">
      ...
      <div className="liquid-glass-modal rounded-[32px] w-full max-w-lg text-white overflow-hidden flex flex-col relative animate-in zoom-in-95 duration-250 group">
        {/* Ambient Fluid Glow */}
        ...
        <button
          onClick={onClose}
          className="absolute top-5 right-5 w-8 h-8 rounded-full bg-white/5 hover:bg-white/15 border border-white/10 flex items-center justify-center text-slate-300 hover:text-white transition-all z-10 cursor-pointer backdrop-blur-md"
        >
          <X className="w-4 h-4" />
        </button>
        ...
        {step === 1 && (
          <div className="p-6 sm:p-8 space-y-6 text-center animate-in fade-in">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-blue-600/30 to-indigo-500/20 border border-white/20 text-blue-300 mx-auto flex items-center justify-center shadow-[inset_0_1px_1px_rgba(255,255,255,0.4)]">
            ...
            <div className="grid grid-cols-3 gap-2.5 pt-2 text-center text-xs">
              <div className="p-3.5 rounded-2xl liquid-glass-card">
                <FileSearch className="w-5 h-5 text-blue-400 mx-auto mb-1" />
