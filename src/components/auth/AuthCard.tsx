...
export default function AuthCard({
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-[#080a0f] via-[#0e131b] to-[#121924] text-white flex flex-col justify-between p-3 sm:p-6 lg:p-8 relative overflow-hidden select-none">
      ...
      <div className="max-w-6xl w-full mx-auto flex items-center justify-between z-10">
        ...
        <Link
          href="/"
          className="text-xs text-slate-400 hover:text-white flex items-center gap-1.5 transition-colors px-3 py-1.5 rounded-xl hover:bg-white/5 border border-transparent hover:border-white/10 touch-target"
        >
      ...
      {/* Main Card */}
      <div className="w-full max-w-md mx-auto my-auto z-10 py-4 sm:py-6">
        <div className="bg-[#121722]/95 backdrop-blur-xl border border-white/10 rounded-2xl sm:rounded-3xl p-5 sm:p-8 shadow-2xl shadow-black/50">
          {/* Header */}
