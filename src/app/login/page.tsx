          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-left">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                <label className="text-xs font-bold text-[#0F172A] dark:text-slate-300">
                  Password
                </label>
                <Link
                  href="/forgot-password"
                  className="text-xs text-[#2563EB] dark:text-blue-400 hover:underline"
                >
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3.5 top-1/2 -translate-y-1/2 text-[#8092A7] hover:text-[#0F172A] dark:hover:text-white"
                >
            ...
            <div className="flex items-center justify-between text-xs pt-1">
              <label className="flex items-center gap-2 cursor-pointer text-[#53627A] dark:text-slate-400">
                <input
                  type="checkbox"
                  checked={rememberMe}
                  onChange={(e) => setRememberMe(e.target.checked)}
                  className="w-4 h-4 rounded border-[#DCE5F0] text-[#2563EB] focus:ring-[#2563EB]"
                />
            ...
            >
              {isSubmitting || isLoading ? (
                ...
                <>
                  <span className="underline decoration-1.5 underline-offset-2">Sign In</span>
